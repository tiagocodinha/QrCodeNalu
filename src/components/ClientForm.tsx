...
const ClientForm: React.FC = () => {
  ...
  if (formSubmitted && generatedQrCode) {
    return <QrCodeDisplay qrCode={generatedQrCode} onReset={handleReset} />;
  }
  ...
  return (
    <div className="w-full max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
      ...
      <p className="text-gray-600 mb-6">
        Join our newsletter and receive a special QR code for 50% off your first drink at Nalu Beach Club.
      </p>
